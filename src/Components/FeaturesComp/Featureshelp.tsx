    ...
    return (
        <div className="grid grid-cols-1 gap-3 md:gap-10 sm:grid-cols-[1fr_300px]">
            ...
            <div className="grid grid-cols-1 gap-10 px-4 sm:px-2">
                {news.map((item) => (
                    <Link to={`/news/${item._id}`} key={item._id} className="flex flex-col md:flex-row cursor-pointer group gap-2">
...
const Ads = () => {
    return (
        <div className="h-[60%] w-full bg-lime-500 flex justify-center items-center">
